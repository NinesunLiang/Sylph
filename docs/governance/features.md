...
**包含内容**：Harness-kit (29 个底层 Hooks) + 7 款门禁审查 Skill。
| 能力 | 作用 | 触发方式 |
| :--- | :--- | :--- |
...
**包含内容**：基础版的全部能力 + 以下 16 款主动工作流 Skill。

### 1. 三大任务驱动引擎 (Task Drivers)

* **/lx-rpe**：大型特性流水线。包含 Research -> Plan

> Execute 三阶段，带有 **50% 上下文甜点区主动交接** 及 A/B 终端盲审对抗。
...
| 文件 | 说明 |
| :--- | :--- |
| **`manual-acceptance-test.md`** | 全人工验收清单，共 **49 项**，覆盖 harness-kit 全部 29 个底层 Hook 及所有核心 Skill。每一条命令你亲自执行，每一个结果你亲眼确认。Agentic UI 的拦截弹窗由 Hook 真实触发，而非 AI 模拟。 |
