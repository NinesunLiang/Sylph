...
- **Level 2 - Base Edition**：静默守护者。增加 7 款自动化审查门禁，被动触发，全自动运行。
- **Level 3 - Enhanced Edition**：高阶武器库。23 款流水线 Skill，主动式调度，需要指挥权。
...
| 能力模块 | 具体包含 | 说明 |
|:---------|:---------|:-----|
| 底层防线 (Hooks) | `privacy-gate`, `context-guard`, `permission-gate` 等 29 个 Hook | 拦截隐私泄露、危险命令、80% Context 熔断、记录错误 DNA |
...
**构成**：Level 1 全部防线 + 7 款自动化审查门禁 Skills
...
**构成**：Level 2 全部能力 + 16 款主动式工作流 Skills
...
| Skill | 定位 | 说明 |
|:------|:-----|:-----|
| `/lx-rpe` | 大型特性流水线 | Research → Plan → Execute 三阶段，带 50% 甜点区交接与 A/B 盲审对抗 |
...
| 文件 | 说明 |
|:-----|:-----|
| `tests/manual-acceptance-test.md` | 49 项全人工验收清单，覆盖全部 29 个 Hook 及核心 Skill |
