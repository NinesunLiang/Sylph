...
| # | 篇章 | 文件 | 覆盖机制数 | 故事隐喻 |
|---|------|------|-----------|---------|
| 0 | 因果基座 | [cn/story-01.md](cn/story-01.md) 第零柱 | 所有机制的根 | 不设计环境，只生长环境 |
| 1 | 七柱圣殿 | [cn/story-01.md](cn/story-01.md) | 7 哲学 + 冲突裁决 | 宇宙创世法则 |
| 2 | 八道铁律 | [cn/story-02.md](cn/story-02.md) | 8 铁律 + 惩罚 | 不可违逆的天条 |
| 3 | 门禁骑士团 | [cn/story-03.md](cn/story-03.md) | 15 hooks | 边防哨所，层层安检 |
| 4 | 证据裁判庭 | [cn/story-04.md](cn/story-04.md) | 10 hooks | 四层证据链的交响曲 |
| 5 | 记忆神殿 | [cn/story-05.md](cn/story-05.md) | 8 hooks + 知识文件 | 记忆的保存、传承与升华 |
| 6 | 上下文守望者 | [cn/story-06.md](cn/story-06.md) | 6 hooks | 资源哨兵，防止记忆洪灾 |
...
| 14 | 圣器锻造所 | [cn/story-14.md](cn/story-14.md) | 24 skills | 工匠的工具箱 |
| 15 | 元环：蛇吞己尾 | [cn/story-15.md](cn/story-15.md) | 协议 + scripts | 自己治理自己的悖论之美 |
| 16 | 双生判官 | [cn/story-16.md](cn/story-16.md) | 2 skills + 2 hooks | Oracle与Meta-Oracle的涌现 |
...
| 机制 | 故事 # |
|------|--------|
| 第零柱: 因果 — 不设计环境，只生长环境 | 1 |
| 哲学 #1 The Less, The More | 1 |
| 哲学 #2 少量正确大增益 | 1 |
| 哲学 #3 先守护，后激发 | 1 |
| 哲学 #4 没通过验证等于没做 | 1, 4 |
| 哲学 #5 以人为本 | 1 |
| 哲学 #6 先天对 AI 0 信任 | 1, 11, 16 |
| 哲学 #7 文档优先，调研先行 | 1, 12 |
| 哲学冲突裁决（优先级锁链） | 1 |
...
| stop-drain | 13 |
| skill-flywheel | 12 |
| skill-usage-tracker | 6 |
| knowledge-condenser | 5 |
| meta-oracle-trigger | 11, 16 |
| agentic-ui | 3, 5 |
...
| lx-oracle | 16 |
| lx-oracle-v2 | 16 |
| lx-root-cause-analysis | 13, 14 |
| lx-skillify | 14 |
| lx-stepwise | 14 |
| lx-sync | 15 |
| lx-validate-skill | 14 |
| update-carror-os | 15 |
...
| claim-lint.sh | 4, 10 |
| harness-kit-install.sh | 3, 14 |
| harness-kit-uninstall.sh | 3 |
| install.sh | 14 |
...
- **新玩家**：从 #0 因果基座（story-01 开篇）开始了解所有的根，然后 #1 七柱圣殿了解世界观基石，再按兴趣跳跃
- **机制查询**：通过上方映射表找到感兴趣的具体机制，跳到对应故事
- **深度游览**：按 #0 → #1 → #3 → #4 → #6 → #11 → #16 → #15 的顺序，跟随"因果 → 门禁 → 验证 → 记忆 → 审计 → 审判 → 自噬"的主线

## 叙事约定

- 所有故事中出现的机制行为均来自真实源码（`file:line` 可追溯），且从真实因果中生长而出
- 人物化命名：hooks = 骑士/守卫，skills = 工匠/术士，哲学 = 宇宙法则，scripts = 审计师/炼金术士
- 复合机制用"团队协作场景"呈现，体现真实的事件链与数据流
- 每个机制必须有其"因果出处"——它是从哪个教训、哪次事故、哪个 R 条目中生长出来的
