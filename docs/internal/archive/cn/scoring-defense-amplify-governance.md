...
> ⚠️ **[评分标准已过期]** — 此文件评分标准与 audit-v6.1.8-rev2 审计不一致，保留仅供历史参考。
...
> **注意**：以下为详细分项评分。综合三维度总分以 `audit-v6.1.8-rev2.md` 为准（72/100）。
> rev2 总分构成：Capability (AI 能力激发) 72 / Defense (错误防护) 76 / Gov. (长期治理) 68。
