...
| 0:45-0:60 | Side-by-side: AI CLI without governance (prompt ignored) vs same CLI with Carror OS (blocked) | "Prompt vs. Physics. Choose your defense." |
...
### Branding
- Header bar in screenshots: optional "Carror OS v6.1.9" watermark bottom-right
