...
```
bashpy
thon3 .claude/skills/lx-varlock/scripts/varlock.py read .env# 返回脱敏结果：DB_PASS=[MASKED_DB_PASS]
...
```
bashpy
thon3 .claude/skills/lx-varlock/scripts/varlock.py write .env "DB_HOST=127.0.0.1\nDB_PASS=[MASKED_DB_PASS]"
...
```
bashpy
thon3 .claude/skills/lx-varlock/scripts/varlock.py run "curl -X POST <https://api.openai.com/v1/chat/completions> -H 'Authorization: Bearer [MASKED_OPENAI_API_KEY]' -d '{\"model\": \"gpt-4o\"}'"
