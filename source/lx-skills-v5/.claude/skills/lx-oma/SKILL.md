...
```bash
i
r -p rpe/feat-XXXecho "# [Feature] XXX 的需求" > rpe/feat-XXX/prd.mdecho "# 技术调研" > rpe/feat-XXX/research.mdecho "# 实施计划"
...
```底
层
的 OMA 文件锁 (Micro-OS Mutex) 已就绪，冲突将自动挂起排队，尽情享受最高密度的并发生产力！
