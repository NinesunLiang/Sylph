---
name: lx-frontend-test
description: "前端测试模板：系统化调试报告输出"
when_to_use: "Use when debugging frontend issues, writing test reports, or generating systematic debugging output."
model: sonnet
effort: medium
---
