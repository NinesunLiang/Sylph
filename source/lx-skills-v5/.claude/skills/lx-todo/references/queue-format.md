...
down# Todo List
## 待处理
- [ ] #1 🐛 P1 QueryTasks 空 slice 未做 len 检查 · source:code-review-H4 · 2024-01-15
- [ ] #2 ✨ P2 日志加 requestID 上下文 · source:自发现 · 2024-01-15
## 进行中
- [-] #3 🔧 P1 TaskModel 接口拆分 · source:code-review-D2 · started:2024-01-15
## 已完成
- [x] #0 🐛 P1 FindTask nil 检查缺失 · source:code-review-H1 · done:2024-01-14 · files:1
## 已升级到 lx-task-spec
- [↑] #4 ✨ P0 新增批量导出 API · reason:需设计+>3文件 · upgraded:2024-01-15
```
**字段定义**：
| 字段 | 必填 | 格式 | 说明|
|------|------|------|------|
