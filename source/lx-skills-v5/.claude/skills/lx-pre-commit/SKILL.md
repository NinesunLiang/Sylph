...
| 技能 | 关联关系 |
|------|---------|
| [lx-code-review](../lx-code-review/SKILL.md) | Step 2 自动调用进行 Go 项目代码审查 |
| [lx-react-review](../lx-react-review/SKILL.md) | Step 2 前端项目替代 lx-code-review |
| [lx-pre-push](../lx-pre-push/SKILL.md) | pre-commit 通过后的下一道推送前门禁 |
