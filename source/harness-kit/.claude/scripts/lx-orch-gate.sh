...
if verdict == 'approve':
    ...
    print(f"")
    print(f"  建议下一步:")
    print(f"    1. lx-orch advance — 推进到下一阶段")
    print(f"    2. lx-orch status — 查看更新后管线全景")
    print(f"    3. 自定义操作 — 输入你想要的命令")
else:
    print(f"\n─── 方向指引 ───")
    ...
    print(f"")
    print(f"  建议下一步:")
    print(f"    1. lx-orch gate {gate_id} approve --reason ... — 重新批准（如果问题已解决）")
    print(f"    2. lx-orch status — 查看当前状态")
    print(f"    3. 自定义操作 — 输入你想要的命令")
PYEOF
