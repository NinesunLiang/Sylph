...
| 维度 | 基线 | 当前 | 目标 | 状态 |
|---|---|---|---|---|
| C1-C9 加权 | 690/1050 = **6.57** | 720/1050 = 6.86 | ≥8.6 | ⬜ |
| E1-E8 加权 | 659/1100 = **5.99** | 698/1100 = 6.35 | ≥8.6 | ⬜ |
| 长期治理 均分 | 49/70 = **7.00** | 7.00 | ≥8.6 | ⬜ |
| **24 项总加权** | 1398/2220 = **6.30** | 1467/2220 = 6.61 | **≥8.6** | ⬜ |
| **24 项最低分** | **4.0 (E3)** | 4.0 | **≥8.0** | ⬜ |
...
| C5 | 工具生命周期 | 10 | 6 | 6→7 | 无 PreCompact/SessionEnd/SubagentStop、launcher fail-open(H3 已修✓R0)、verify_gate 孤儿 | R2+R3 |
...
| C9 | 错误恢复 | 10 | 7 | 7 | compact-write detached 静默、跨任务 S1 污染恢复证据 | R2+R3 |
...
| E2 | 幻觉输出 | 20 | 6 | 6 | verify_gate 不在生产链路、claim-evidence 机械校验缺失 | R2 |
| E3 | 虚假完成 | 15 | **4** | 4 | cmd_verify 不调 verify_gate(carros_base.py:788-864)、_check_verified(None) 通配（pretool-gate.py:268)、跨任务 S1 重放 | **R2 靶心** |
...
| R2 | PKG-A 验证链（整合器施工） | （待填） | E3 4→9、E2 6→8、C5→8、C9→8、人机权限 7→8 |
