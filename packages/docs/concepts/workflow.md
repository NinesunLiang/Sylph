...
The base layer. 30 physical hook scripts that intercept AI actions at the filesystem level. No user-facing commands, no active workflows -- just silent protection.
...
Layer 1 + 7 automated Skill gates that run during commit workflows:
...
Layer 2 + 16 active workflow Skills. These require learning but deliver industrial-grade AI-assisted development.
...
- [Editions: Three-layer comparison](../governance/editions.md)
- [Quickstart: Install Base](../guides/quickstart.md)
- [For Experts: Enhanced activation](../guides/for-experts.md)
