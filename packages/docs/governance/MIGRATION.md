...
> **版本**：v6.1.8 | **日期**：2026-05-03> **核心原则**：升级系统（Update OS）绝对不能抹除用户的数据资产（User Data & Configurations）。
...
| :--- | :--- | :--- | :--- |
| **系统核心** (Kernel) | `.claude/hooks/*.sh` / `.opencode/plugins/` | 30 个注册应用层拦截器、探针脚本。 | **无情覆盖** (随新版本热更，保证防线最新) |
