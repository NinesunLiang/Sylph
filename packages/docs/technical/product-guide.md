...
| 能力模块 | 具体包含 | 说明 |
|:---------|:---------|:-----|
| 底层防线 (Hooks) | `privacy-gate`, `context-guard`, `permission-gate` 等 30 个注册 Hook | 拦截隐私泄露、危险命令、80% Context 熔断、记录错误 DNA |
...
| 文件 | 说明 |
|:-----|:-----|
| `docs/tests/manual-acceptance-test.md` | 49 项全人工验收清单，覆盖全部 30 个注册 Hook 及核心 Skill |
