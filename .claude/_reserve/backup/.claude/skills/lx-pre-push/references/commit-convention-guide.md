...
```bash
n
3 .claude/skills/lx-pre-push/scripts/commit_convention.py learn \ "feat(user): add phone login
- Support SMS verification- Token refresh integration
...
```bash
n
3 .claude/skills/lx-pre-push/scripts/commit_convention.py validate-batch \ --prod <线上版本commit-hash>
...
```bash
# 查看当前规范python3 .claude/skills/lx-pre-push/scripts/commit_convention.py show
