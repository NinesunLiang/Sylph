...
> **收敛规则（ADR0017）**：`.claude/references/` 是文档唯一真源集合；编号文档冲突时大编号优先（如 19.md > 17.md）；同主题当前状态 = 最大编号文档 + 对应 ADR。
> 历史存档: `1.md`~`12.md`（第三轮迭代设计 2026-07-12 冻结 + 演进记录）及 align/data_todo/update/总结/过程文档已归档至 `archived/design-docs/`，保留但不反映当前状态。仅 `13-headless-lightweight-actions.md` 为当前活文档。
