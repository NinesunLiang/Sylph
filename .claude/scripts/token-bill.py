#!/usr/bin/env python3
"""
token-bill.py — 跨会话 Token 经济历史账单
Cross-platform Python resolution (DG-105)
用法: python3 .claude/scripts/token-bill.py [--json]
"""
import sys
import os
import json
...
SAVINGS = PROJECT_ROOT / ".omc" / "state" / "token-savings.json"
SAVINGS_LOG = PROJECT_ROOT / ".omc" / "state" / "token-savings.jsonl"
JSON_OUT = "--json" in sys.argv[1:]

COST_PER_1M = 2.0  # $2/1M input tokens
CHARS_PER_TOKEN = 4  # 每4字符 ≈ 1 token (估算)
