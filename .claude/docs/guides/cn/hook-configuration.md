...
| `inject_project_knowledge` | ~~true~~ → 已移除 v7.x | 功能已由 session-start.py 替代 |
...
| `anti_pattern_detect` | ~~true~~ → 已移除 v7.x | 软词检测已由 completion-gate.py 吸收 |
...
| `skill_usage_tracker` | ~~true~~ → 已移除 v7.x | ROI 不足，功能未部署 |
